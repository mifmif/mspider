...
public class JpaDaoFactory {
	...
	private static final ParameterValueDao jpaParameterValueDao = new JpaParameterValueDao();
	...
	public static ParameterValueDao getJpaParameterValueDao() {
		return jpaParameterValueDao;
	}
}
